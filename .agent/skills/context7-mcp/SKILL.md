---
name: context7-mcp
description: Fetch up-to-date documentation, API references, and code examples for libraries, frameworks, SDKs, and tools used in FieldForge (e.g. NestJS, Drizzle ORM, Turborepo, Next.js, React 19, Tailwind CSS, Redux Toolkit, Expo, React Native, Zod, RabbitMQ/amqplib).
---
...
| **Web Framework**           | Next.js            | `/vercel/next.js` or `/websites/nextjs` | `16.3.4` (App Router)                 |
| **Web Frontend**            | React              | `/react/react`                          | `^19.2.8`                             |
| **Styling**                 | Tailwind CSS       | `/tailwindlabs/tailwindcss`             | `^4.3.3` (via `@tailwindcss/postcss`) |
